<?php declare(strict_types=1);
  ...
  spl_autoload_register(function ($class) {
    require __DIR__ . "/src/$class.php";// sử dụng hằng số ảo __DIR__ để trả về đường dân tuyệt đối của file này, thuận tiện hơn cho việc chạy bằng terminal
...
set_exception_handler('ErrorHandler::handleException'); // đăng ký hàm xử lý ngoại lệ
  ...
  if (basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)) !== 'invoices.php') {
  ...
  $controller->processRequestInvoice($_SERVER['REQUEST_METHOD'], $userid);
  ?>
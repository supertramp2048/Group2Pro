<template>
  <div>
    ...
    <div v-else>
      ...
      <div v-if="selectedInvoice" class="fixed inset-0 bg-gray-700 bg-opacity-50 flex justify-center items-center">
          ...
          <table class="table-auto w-full border border-gray-300 mb-4">
            ...
            <tbody>
              <tr v-for="item in selectedInvoice.items" :key="item.id">
                ...
                <td class="border px-2 py-1 text-center">{{ item.price }}</td>
              </tr>
            </tbody>
          </table>

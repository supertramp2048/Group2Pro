      ...
      <div class="w-full max-w-7xl mx-auto">
        ...
        <ul class="hidden lg:flex items-center space-x-8">
          <li
            ...
            :key="index"
            class="relative group px-4 py-2 text-black font-semibold text-sm uppercase tracking-wide transition-all duration-300 hover:text-red-500 hover:scale-105 rounded-lg hover:bg-white/10 backdrop-blur-sm border border-transparent hover:border-red-400/50 hover:shadow-lg hover:shadow-red-500/25"
          >
            <router-link
              v-if="!item.children"
              :to="item.route"
            ...
            >
              {{ item.label }}
              <span
                class="absolute inset-x-0 -bottom-1 h-0.5 bg-gradient-to-r from-red-400 to-red-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"
              ></span>
            </router-link>

            <button v-else class="relative flex text-black font-semibold text-sm uppercase tracking-wide transition-all duration-300" @click="toggle(index)">
            ...
            >
              <ul
                class="bg-white backdrop-blur-xl border border-red-600/30 rounded-xl shadow-2xl shadow-red-500/20 overflow-hidden"
              >
                <li
                ...
                >
                  ...
                  >
                    <div
                      class="w-2 h-2 bg-red-400 rounded-full mr-3 opacity-0 group-hover/item:opacity-100 transition-opacity duration-300"
                    ></div>
                    <span class="relative">
                      {{ child.label }}
                      <span
                        class="absolute inset-x-0 -bottom-1 h-0.5 bg-gradient-to-r from-red-400 to-red-300 transform scale-x-0 group-hover/item:scale-x-100 transition-transform duration-300"
                      ></span>
                    </span>
                  </router-link>
                </li>
          ...
          <li class="relative ml-auto">
            ...
            >
              <ul
                class="bg-gradient-to-br from-red-800 to-red-900 backdrop-blur-xl border border-red-600/30 rounded-xl shadow-2xl shadow-red-500/20 overflow-hidden"
              >
                <li class="group/account border-b border-red-700/50">
                  <div v-if="login" class="px-6 py-4">
                    <div class="flex items-center space-x-4">
                      <div
                        class="w-12 h-12 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center"
                      >
                  ...
                  <div v-else class="px-6 py-4">
                    <div class="flex items-center space-x-4 mb-4">
                      ...
                      >
                        <i
                          class="fa-solid fa-user-slash text-gray-400 text-lg"
                        ></i>
                      </div>
                      <div>
                ...
                <li class="group/item">
                  ...
                  >
                    <div
                      class="w-8 h-8 bg-red-600/20 rounded-full flex items-center justify-center mr-3 group-hover/item:bg-red-600/30 transition-colors duration-300"
                    >
                      <i
                        class="fa-solid fa-sign-out-alt text-red-400 text-sm"
                      ></i>
                    </div>
        ...
        >
          <div
            class="bg-white backdrop-blur-sm rounded-xl border border-red-700/30 p-4"
          >
            <!-- Mobile Menu Items -->
            <div class="space-y-2">
            ...
            <div class="mt-4 pt-4 border-t border-red-700/30">
              <div
                v-if="login"
                class="flex items-center space-x-3 px-4 py-3 bg-red-700/20 rounded-lg"
              >
                <div
  ...
  methods: {
    ...
    toggleMobileDropdown(index) {
      this.mobileDropdownOpen =
        this.mobileDropdownOpen === index ? null : index;
    },
    closeMobileMenu() {
